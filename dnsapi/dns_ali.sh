...
dns_ali_add() {
  ...
  Ali_Key="${Ali_Key:-$(_readdomainconf_mutable Ali_Key)}"
  Ali_Secret="${Ali_Secret:-$(_readdomainconf_mutable Ali_Secret)}"
  ...
  _savedomainconf_mutable Ali_Key "$Ali_Key"
  _savedomainconf_mutable Ali_Secret "$Ali_Secret"
