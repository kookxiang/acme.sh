...
dns_he_add() {
  ...
  HE_Username="${HE_Username:-$(_readdomainconf_mutable HE_Username)}"
  HE_Password="${HE_Password:-$(_readdomainconf_mutable HE_Password)}"
  ...
  _savedomainconf_mutable HE_Username "$HE_Username"
  _savedomainconf_mutable HE_Password "$HE_Password"
